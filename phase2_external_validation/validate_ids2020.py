"""
phase2_external_validation/validate_ids2020.py
================================================
PHASE 2 — External Validation: MQTT-IoT-IDS2020 Dataset
5-Feature selection approach applied to IDS2020.
R4C2: 10-fold stratified CV with full timing statistics.

Pre-processed dataset files expected (produced by a separate preprocessing
notebook/script and saved as .npz + .joblib):
  /content/drive/MyDrive/R3-PMC/Dataset_for_Phase_2/processed_ids2020/
...
SAVE_DIR  = "/content/drive/MyDrive/R3-PMC/Dataset_for_Phase_2/processed_ids2020"
MODEL_DIR = "/content/drive/MyDrive/R3-PMC/Dataset_for_Phase_2/models_ids2020"

# ── Hyperparameters (tuned for IDS2020) ──────────────────────────────────────
CART_HP = dict(criterion="gini", max_depth=5,  min_samples_split=2,
               min_samples_leaf=1, class_weight="balanced")
DT_HP   = dict(criterion="gini", max_depth=22, min_samples_split=2,
               min_samples_leaf=6, max_features="sqrt")
RF_HP   = dict(n_estimators=3,   max_depth=7,  min_samples_split=22,
...
def build_models() -> dict:
    return {
        "CART (IDS2020)"          : DecisionTreeClassifier(**CART_HP, random_state=RANDOM_SEED),
        "Decision Tree (IDS2020)" : DecisionTreeClassifier(**DT_HP,   random_state=RANDOM_SEED),
        "Random Forest (IDS2020)" : RandomForestClassifier(**RF_HP, n_jobs=1, random_state=RANDOM_SEED),
    }
...
def run() -> None:
    ...
    print("\n" + "=" * 70)
    print("IDS2020 — TRAINING  (10-fold stratified CV, R4C2)")
    ...
    print("\n[SUCCESS] IDS2020 models saved to:", MODEL_DIR)
